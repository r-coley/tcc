...
void fa_s1(struct s1 a) { fprintf(stderr,"%.1s\n", a.x); }
void fa_s2(struct s2 a) { fprintf(stderr,"%.2s\n", a.x); }
void fa_s3(struct s3 a) { fprintf(stderr,"%.3s\n", a.x); }
void fa_s4(struct s4 a) { fprintf(stderr,"%.4s\n", a.x); }
void fa_s5(struct s5 a) { fprintf(stderr,"%.5s\n", a.x); }
void fa_s6(struct s6 a) { fprintf(stderr,"%.6s\n", a.x); }
void fa_s7(struct s7 a) { fprintf(stderr,"%.7s\n", a.x); }
void fa_s8(struct s8 a) { fprintf(stderr,"%.8s\n", a.x); }
void fa_s9(struct s9 a) { fprintf(stderr,"%.9s\n", a.x); }
void fa_s10(struct s10 a) { fprintf(stderr,"%.10s\n", a.x); }
void fa_s11(struct s11 a) { fprintf(stderr,"%.11s\n", a.x); }
void fa_s12(struct s12 a) { fprintf(stderr,"%.12s\n", a.x); }
void fa_s13(struct s13 a) { fprintf(stderr,"%.13s\n", a.x); }
void fa_s14(struct s14 a) { fprintf(stderr,"%.14s\n", a.x); }
void fa_s15(struct s15 a) { fprintf(stderr,"%.15s\n", a.x); }
void fa_s16(struct s16 a) { fprintf(stderr,"%.16s\n", a.x); }
void fa_s17(struct s17 a) { fprintf(stderr,"%.17s\n", a.x); }
...
{
    fprintf(stderr,"%.1f %.1f %.1f %.1f %.1Lf %.1Lf\n",
...
{
    fprintf(stderr,"%.1s %.1f %.1f %.2s %.1f %.1f %.3s %.1Lf %.1Lf\n",
