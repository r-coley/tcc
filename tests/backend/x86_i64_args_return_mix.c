/*
 * x86 32-bit cdecl ABI smoke test for mixed scalar and 64-bit arguments.
 *
...
long long x86_i64_args_return_mix_chain(long long seed)
{
    int local;
    long long r;
...
int main(void)
{
     ...
     */
    r = x86_i64_args_return_mix_chain(0x00000000fffffffeLL);
